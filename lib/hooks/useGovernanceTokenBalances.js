...
export const useGovernanceTokenBalancesTotal = () => {
  const { data, isFetched: isGovernanceTokenBalancesFetced } = useGovernanceTokenBalancesFlattened()
  const { data: vestingPoolBalance, isFetched: isVestingPoolBalanceFetched } =
    useVestingPoolBalance()

  const isFetched = isGovernanceTokenBalancesFetced && isVestingPoolBalanceFetched
