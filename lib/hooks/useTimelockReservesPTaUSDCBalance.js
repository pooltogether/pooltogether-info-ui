...
const PTaUSDC_RESERVES_AMOUNT = {
  amount: 959883,
  amountUnformatted: BigNumber.from(959883000000), // 6 decimals
  amountPretty: '959,883'
}
// PTaUSDC_TREASURY_AMOUNT_V4: 2838909

export const useTimelockReservesPTaUSDCBalance = () => {
  ...
  if (isFetched && tokenPrices && tokenBalance) {
    ...
    // This hook is only interested in the constant Reserves balance
    const usdValueUnformatted = amountMultByUsd(PTaUSDC_RESERVES_AMOUNT.amountUnformatted, usd)
